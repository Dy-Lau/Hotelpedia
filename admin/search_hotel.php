...
include_once("../connect/connect.php");
	...
	$hotel_query = "SELECT * FROM hotels, amenities WHERE (hotel_name like '%".$search."%') OR (hotel_address like '%".$search."%') OR (hotel_type like '%".$search."%') OR (hotel_price like '%".$search."%') OR (hotel_class like '%".$search."%') OR (hotel_numrooms like '%".$search."%') OR (amenities_name like '%".$search."%') AND amenities.hotel_id = hotels.hotel_id GROUP BY hotel_name";
	$query = mysqli_query($connect, $hotel_query) or die ("ERROR: " .mysqli_error($connect));
?>
