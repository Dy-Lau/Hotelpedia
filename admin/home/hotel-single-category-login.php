          ...
          <div class="modal-content">
            ...
            <div class="mySlides">
              <div class="numbertext">4 / 4</div>
                <img src="data:image/jpeg;base64, '.base64_encode($row['image4']).'" style="width:100%">
            </div>
      ...
      echo'
          <div id="review-tile">
            ...
            <h5 method="GET" style="color: #555; padding-bottom: 10px; margin:-150px 0 0px 220px;">
              ...
              <a href="delete_review.php?user_id='.$row['user_id'].'&review_id='.$row['review_id'].'&hotel_id='.$hotel_id.'" onclick="javascript:confirmationDelete(this); return false;" style="cursor: pointer; float:right;color:red;">Delete Review</a>
            </h5>
