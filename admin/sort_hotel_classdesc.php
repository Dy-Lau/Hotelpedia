          ...
          <form role="form" action="sort.php" id="sort-form" method="POST">
            <div class="input-group">
              ...
              <select class="form-control sortBar" name="carlist" form="sort-form">
                ...
                <option value="class-highest-lowest" selected="selected">Class: Highest-Lowest</option>
              </select>
...
<?php
      ...
      $query = mysqli_query($connect, "SELECT * FROM hotels, amenities WHERE amenities.hotel_id = hotels.hotel_id ORDER BY hotel_class DESC LIMIT " . $this_page_first_result . ',' .$results_per_page) or die ("ERROR:" .mysqli_error($connect));
      while($row = mysqli_fetch_array($query)){
        ...
        for ($page=1; $page<=$number_of_pages; $page++){
          echo '<div style="text-align: center; margin-left:500px;"><a id="pagination" class="col-xs-4 col-md-1 text-center" href="sort_hotel_classdesc.php?page='.$page.'"> '. $page.' </a></div>';
        }
